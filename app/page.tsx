      ...
      <section className="text-center py-28 px-6">
        ...
        <div className="mt-10 flex justify-center gap-6">
          ...
          <Link
            ...
            className="px-6 py-3 border border-gray-600 rounded-xl hover:border-primary"
          >
            Become Supplier
          </Link>
        </div>
      ...
      <section className="py-20 bg-card">
        <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-10 px-8">
          ...
          {[
            ...
            <div key={i} className="bg-dark p-8 rounded-2xl">
      ...
      <section className="py-20 text-center">
        ...
        <div className="flex justify-center gap-8 flex-wrap">
          ...
          {[
            ...
            <div key={i} className="bg-card p-8 rounded-2xl w-64">
